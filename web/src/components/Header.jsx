                ...
                <div className="sticky top-[4.5rem] z-40 max-w-[600px] mx-auto px-4 mt-2">
                    <div className="flex bg-gray-100/90 backdrop-blur-sm p-1 rounded-xl shadow-sm border border-gray-200/50">
                        <button
                            ...
                            className={`flex-1 py-1.5 text-sm font-medium rounded-lg transition-all duration-200 ${isTabActive("") && !isTabActive("stats") && !isTabActive("settle") ? "bg-white text-gray-800 shadow-sm" : "text-gray-500 hover:text-gray-700 hover:bg-gray-200/50"}`}
                        >
                            List
                        </button>
                        <button
                            onClick={() => navigate(`/g/${params.guid}/settle`)}
                            className={`flex-1 py-1.5 text-sm font-medium rounded-lg transition-all duration-200 ${isTabActive("settle") ? "bg-white text-gray-800 shadow-sm" : "text-gray-500 hover:text-gray-700 hover:bg-gray-200/50"}`}
                        >
                            Settle Up
                        </button>
                        <button
